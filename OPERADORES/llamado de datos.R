...
load(str_c(getwd(),"/salidastodaOperadorFAM.RData"))#salida ultimo
#load(str_c(getwd(),"/cuartiles751.RData"))#salida ultimo
#load(str_c(getwd(),"/cuartiles75COT.RData"))#salida ultimo



load(str_c(getwd(),"/salidastodaOperadorF.RData"))#salida ultimo
load(str_c(getwd(),"/cuartiles751.RData"))#salida ultimo
load(str_c(getwd(),"/cuartiles75COT.RData"))#salida ultimo

load(str_c(getwd(),"/usostodos.RData"))#scrip operador..POR DIA_MES    IGUAL
load(str_c(getwd(),"/Atrasos.RData"))#scrip operador..POR DIA_MES      IGUAL
load(str_c(getwd(),"/adelantos.RData"))#scrip operador..POR DIA_MES    IGUAL
load(str_c(getwd(),"/salidas.RData"))#salida ultimo POR DIA_MES       IGUAL


load(str_c(getwd(),"/Ano_MES_Objet.RData"))#libre inamovible
load(str_c(getwd(),"/BaseDatosReinci.RData"))#historia de conducta del operador 
...
salidas<-salidastodaOperadorFAM[,c(1:5,14,12)]
Adelantos<-salidastodaOperadorFAM[,c(1:5,14,25)]
atrasos<-salidastodaOperadorFAM[,c(1:5,14,26)]
usos<-salidastodaOperadorFAM[,c(1:5,14,21)]
...
load(str_c(getwd(),"/BDM_A_B.RData"))#base de datos para los novedades de todos los niveles de reincidencia 
load(str_c(getwd(),"/seisBDM_A_B.RData"))#novedades de los seis meses-debe hacer un filtro para determinar 6 novedades en los ultimos seis meses 
load(str_c(getwd(),"/altomediobajo.RData"))#los pocicionados en esos niveles 
...
Niveles<-as.data.table(read_excel("C:/Users/emosquera/OneDrive - metrocali.gov.co/Fuentes de Informacion - reincidencia/Accidentalidad Consolidada.xlsx", sheet = "Tabla Detallada", col_names = F))
...
salidastodaOperadorOP<-salidastodaOperadorFAM
...
salidastodaOperador<-data.frame(t(salidastodaOperadorF))
...
#usoshabil<-replace(usoshabil,is.na(usoshabil),0)
#usoshabil<-usoshabil[usoshabil$CONDUCTOR != 0]

#usosRura<-data.frame(t(usoshabil))
...
TusosCOT<-salidastodaOperadorOP[,c(1,2,16)]
TusosCOT$tasa_usosQ25<-as.numeric(TusosCOT$tasa_usosQ25)

TusosCOTOperador<-TusosCOT
TusosCOTOperador$COT<-replace(TusosCOTOperador$COT,TusosCOTOperador$COT== "1","GIT")
TusosCOTOperador$COT<-replace(TusosCOTOperador$COT,TusosCOTOperador$COT== "3","ETM")
TusosCOTOperador$COT<-replace(TusosCOTOperador$COT,TusosCOTOperador$COT== "2","BYN")

TusosCOTOperadorG<-TusosCOTOperador[TusosCOTOperador$COT=="GIT"]
TusosCOTOperadorB<-TusosCOTOperador[TusosCOTOperador$COT=="BYN"]
TusosCOTOperadorE<-TusosCOTOperador[TusosCOTOperador$COT=="ETM"]

TusosCOTOperadorG<- TusosCOTOperadorG[order((as.numeric(TusosCOTOperadorG$tasa_usosQ25)),decreasing = TRUE), ]
TusosCOTOperadorB<- TusosCOTOperadorB[order((as.numeric(TusosCOTOperadorB$tasa_usosQ25)),decreasing = TRUE), ]
TusosCOTOperadorE<- TusosCOTOperadorE[order((as.numeric(TusosCOTOperadorE$tasa_usosQ25)),decreasing = TRUE), ]

TusosCOTOperadorG<-TusosCOTOperadorG[1:10,]
TusosCOTOperadorB<-TusosCOTOperadorB[1:10,]
TusosCOTOperadorE<-TusosCOTOperadorE[1:10,]

TusosCOTOperadorusos<-rbind(TusosCOTOperadorG,TusosCOTOperadorB,TusosCOTOperadorE)


TusosCOT<-salidastodaOperadorOP[,c(1,2,17)]
TusosCOT$tasa_Adelantos<-as.numeric(TusosCOT$tasa_Adelantos)
...
TusosCOTOperadorG<- TusosCOTOperadorG[order((as.numeric(TusosCOTOperadorG$tasa_Adelantos)),decreasing = TRUE), ]
TusosCOTOperadorB<- TusosCOTOperadorB[order((as.numeric(TusosCOTOperadorB$tasa_Adelantos)),decreasing = TRUE), ]
TusosCOTOperadorE<- TusosCOTOperadorE[order((as.numeric(TusosCOTOperadorE$tasa_Adelantos)),decreasing = TRUE), ]

TusosCOTOperadorG<-TusosCOTOperadorG[1:10,]
TusosCOTOperadorB<-TusosCOTOperadorB[1:10,]
TusosCOTOperadorE<-TusosCOTOperadorE[1:10,]

TusosCOTOperadorAdelantos<-rbind(TusosCOTOperadorG,TusosCOTOperadorB,TusosCOTOperadorE)

TusosCOT<-salidastodaOperadorOP[,c(1,2,18)]
TusosCOT$tasa_Atrazos<-as.numeric(TusosCOT$tasa_Atrazos)
TusosCOTOperador<-TusosCOT
TusosCOTOperador$COT<-replace(TusosCOTOperador$COT,TusosCOTOperador$COT== "1","GIT")
TusosCOTOperador$COT<-replace(TusosCOTOperador$COT,TusosCOTOperador$COT== "3","ETM")
TusosCOTOperador$COT<-replace(TusosCOTOperador$COT,TusosCOTOperador$COT== "2","BYN")
...
TusosCOTOperadorG<- TusosCOTOperadorG[order((as.numeric(TusosCOTOperadorG$tasa_Atrazos)),decreasing = TRUE), ]
TusosCOTOperadorB<- TusosCOTOperadorB[order((as.numeric(TusosCOTOperadorB$tasa_Atrazos)),decreasing = TRUE), ]
TusosCOTOperadorE<- TusosCOTOperadorE[order((as.numeric(TusosCOTOperadorE$tasa_Atrazos)),decreasing = TRUE), ]

TusosCOTOperadorG<-TusosCOTOperadorG[1:10,]
TusosCOTOperadorB<-TusosCOTOperadorB[1:10,]
TusosCOTOperadorE<-TusosCOTOperadorE[1:10,]

TusosCOTOperadorAtrasos<-rbind(TusosCOTOperadorG,TusosCOTOperadorB,TusosCOTOperadorE)

TusosCOT<-salidastodaOperadorOP[,c(1,2,10)]
TusosCOT$tasa_Salidas<-as.numeric(TusosCOT$tasa_Salidas)
TusosCOTOperador<-TusosCOT
TusosCOTOperador$COT<-replace(TusosCOTOperador$COT,TusosCOTOperador$COT== "1","GIT")
TusosCOTOperador$COT<-replace(TusosCOTOperador$COT,TusosCOTOperador$COT== "3","ETM")
TusosCOTOperador$COT<-replace(TusosCOTOperador$COT,TusosCOTOperador$COT== "2","BYN")
...
TusosCOTOperadorG<- TusosCOTOperadorG[order((as.numeric(TusosCOTOperadorG$tasa_Salidas)),decreasing = TRUE), ]
TusosCOTOperadorB<- TusosCOTOperadorB[order((as.numeric(TusosCOTOperadorB$tasa_Salidas)),decreasing = TRUE), ]
TusosCOTOperadorE<- TusosCOTOperadorE[order((as.numeric(TusosCOTOperadorE$tasa_Salidas)),decreasing = TRUE), ]

TusosCOTOperadorG<-TusosCOTOperadorG[1:10,]
TusosCOTOperadorB<-TusosCOTOperadorB[1:10,]
TusosCOTOperadorE<-TusosCOTOperadorE[1:10,]

TusosCOTOperadorSalidas<-rbind(TusosCOTOperadorG,TusosCOTOperadorB,TusosCOTOperadorE)

TusosCOT<-salidastodaOperadorOP[,c(1,2,16)]
TusosCOT$tasa_usosQ25<-as.numeric(TusosCOT$tasa_usosQ25)
TusosCOT1<-data.frame(tapply(as.numeric(TusosCOT$tasa_usosQ25),TusosCOT$COT,mean))
TusosCOT1<-cbind(row.names(TusosCOT1),TusosCOT1)
names(TusosCOT1)=c("COT","Tasa_usos")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "1","GIT")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "3","ETM")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "2","BYN")
TusosCOT1<-as.data.table(TusosCOT1)
#TusosCOT1[,Sistema:=round(mean(as.numeric(TusosCOT$tasa_usosQ25)),0)]
TusosCOT1$Tasa_usos<-round(TusosCOT1$Tasa_usos,0)
Tasa_Usos<-TusosCOT1

TusosCOT<-salidastodaOperadorOP[,c(1,2,10)]
TusosCOT$tasa_Salidas<-as.numeric(TusosCOT$tasa_Salidas)
TusosCOT1<-data.frame(tapply(as.numeric(TusosCOT$tasa_Salidas),TusosCOT$COT,mean))
TusosCOT1<-cbind(row.names(TusosCOT1),TusosCOT1)
names(TusosCOT1)=c("COT","Tasa_Salidas")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "1","GIT")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "3","ETM")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "2","BYN")
TusosCOT1<-as.data.table(TusosCOT1)
#TusosCOT1[,Sistema:=round(mean(as.numeric(TusosCOT$tasa_Salidas)),0)]
TusosCOT1$Tasa_Salidas<-round(TusosCOT1$Tasa_Salidas,0)
Tasa_Salidas<-TusosCOT1


TusosCOT<-salidastodaOperadorOP[,c(1,2,17)]
TusosCOT$tasa_Adelantos<-as.numeric(TusosCOT$tasa_Adelantos)
TusosCOT1<-data.frame(tapply(as.numeric(TusosCOT$tasa_Adelantos),TusosCOT$COT,mean))
TusosCOT1<-cbind(row.names(TusosCOT1),TusosCOT1)
names(TusosCOT1)=c("COT","Tasa_Adelantos")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "1","GIT")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "3","ETM")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "2","BYN")
TusosCOT1<-as.data.table(TusosCOT1)
#TusosCOT1[,Sistema:=round(mean(as.numeric(TusosCOT$tasa_Adelantos)),0)]
TusosCOT1$Tasa_Adelantos<-round(TusosCOT1$Tasa_Adelantos,0)
Tasa_Adelantos<-TusosCOT1

TusosCOT<-salidastodaOperadorOP[,c(1,2,18)]
TusosCOT$tasa_Atrazos<-as.numeric(TusosCOT$tasa_Atrazos)
TusosCOT1<-data.frame(tapply(as.numeric(TusosCOT$tasa_Atrazos),TusosCOT$COT,mean))
TusosCOT1<-cbind(row.names(TusosCOT1),TusosCOT1)
names(TusosCOT1)=c("COT","Tasa_atrasos")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "1","GIT")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "3","ETM")
TusosCOT1$COT<-replace(TusosCOT1$COT,TusosCOT1$COT== "2","BYN")
#TusosCOT1<-as.data.table(TusosCOT1)

#TusosCOT1[,Sistema:=round(mean(as.numeric(TusosCOT$tasa_Atrazos)),0)]
TusosCOT1$Tasa_atrasos<-round(TusosCOT1$Tasa_atrasos,0)
Tasa_Atrasos<-TusosCOT1

TusosCOT1<-cbind(Tasa_Atrasos,Tasa_Adelantos,Tasa_Salidas,Tasa_Usos)
#TusosCOT1<-rbind(t(Tasa_Atrasos[,2]),t(Tasa_Adelantos[,2]),t(Tasa_Salidas[,2]),t(Tasa_Usos[,2]))
TusosCOT1<-TusosCOT1[,-c(3,5,7)]
TusosCOT1<-as.data.frame(t(TusosCOT1))
TusosCOT1<-TusosCOT1[-1,]
...
indicadores<-cbind(row.names(TusosCOT1),(TusosCOT1))
names(indicadores)=c("Indicador","GIT","BYN","ETM")

indicadores$GIT<-as.numeric(indicadores$GIT)
indicadores$BYN<-as.numeric(indicadores$BYN)
indicadores$ETM<-as.numeric(indicadores$ETM)
indicadores<-as.data.table(indicadores)
indicadores<-indicadores[,Total:=(round(((GIT+BYN+ETM)/3),0))]

indicadores$Indicador<-replace(indicadores$Indicador,indicadores$Indicador== "Tasa_atrasos","%((Atrasos/Totalparadas)*100)")
indicadores$Indicador<-replace(indicadores$Indicador,indicadores$Indicador== "Tasa_Salidas","(Salidas/horas laboradas)*1000")
indicadores$Indicador<-replace(indicadores$Indicador,indicadores$Indicador== "Tasa_usos","(veces con Usos bajos/horas laboradas)*1000")
indicadores$Indicador<-replace(indicadores$Indicador,indicadores$Indicador== "Tasa_Adelantos","%((Adelantos/Totalparadas)*100)")
indicadores1<-indicadores[c(1,2),]
indicadores1$GIT<-paste(indicadores1$GIT,"%",sep = "")
indicadores1$BYN<-paste(indicadores1$BYN,"%",sep = "")
indicadores1$ETM<-paste(indicadores1$ETM,"%",sep = "")
indicadores1$Total<-paste(indicadores1$Total,"%",sep = "")
indicadores3<-rbind(indicadores1,indicadores[c(3,4),])
